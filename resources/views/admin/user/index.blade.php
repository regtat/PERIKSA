                    ...
                    <tbody>
                        @foreach ($users as $user)
                            <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b">
                                <th scope="row" class="px-4 py-3 font-medium text-gray-800 whitespace-nowrap">
                                    {{ $user->email }}
                                </th>
                                <td scope="row" class="px-6 py-3 font-medium text-gray-800 whitespace-nowrap">
                                    {{ $user->password }}
                                </td>
                                <td scope="row"
                                    class="ml-auto flex space-x-3 px-6 py-3 items-center justify-center font-medium text-gray-800 whitespace-nowrap">
