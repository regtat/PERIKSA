<nav class="position-fixed top-0 left-0 z-20 " style="background-color: #E4C4E2;" x-data="{ isOpen: false }">
            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <x-nav-link href="{{ route('mahasiswa.pengaduans.index') }}" :active="request()->routeIs('mahasiswa.pengaduans')">Pengaduan</x-nav-link>
                ...
                <div class="ml-4 flex items-center md:ml-6">
                    ...
                    <div class="relative ml-3">
                        ...
                        <div x-show="isOpen" x-transition:enter="transition ease-out duration-100 transform" x-transition:enter-start="opacity-0 scale-95" x-transition:enter-end="opacity-100 scale-100" x-transition:leave="transition ease-in duration-75 transform" x-transition:leave-start="opacity-100 scale-100" x-transition:leave-end="opacity-0 scale-95" class="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
                            ...
                            @if(Auth::user()->nim!=null)
                            <a href="{{ route('mahasiswa.profil.index') }}" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-0">PROFIL AKUN</a>
                            @elseif(Auth::user()->nip!=null)
                            <a href="{{ route('wd.profil.index') }}" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-0">PROFIL AKUN</a>
                            @else
                            <a href="{{ route('admin.profil.index') }}" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-0">PROFIL AKUN</a>
                            @endif
    ...
    <div x-show="isOpen" class="md:hidden" id="mobile-menu">
        <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
            ...
            <a href="{{route('mahasiswa.pengaduans.index')}}" class="text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium">Pengaduan</a>
            <a href="{{route('mahasiswa.kritiksarans.index')}}" class="text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium">Kritik dan Saran</a>
            @elseif(Auth::user()->nip!=null)
            ...
            <a href="{{route('wd.pengaduans')}}" class="text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium">Pengaduan</a>
            <a href="{{route('wd.kritiksarans')}}" class="text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium">Kritik dan Saran</a></div>
            @else
            ...
            <a href="{{route('admin.pengaduans')}}" class="text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium">Pengaduan</a>
            <a href="{{route('admin.kritiksarans')}}" class="text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium">Kritik dan Saran</a>
            @endif
